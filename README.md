...
* M5 Fire has three physical buttons that act as cursor up/down and Enter (holding middle does Shift-Run, holding left switches to next emulator, holding right does STOP).  M5 Core2 and CoreS3 have virtual buttons with same behaviors.
