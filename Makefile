...
c-simple-emu6502-cbm.exe: obj/main.o obj/emuc64.o obj/emud64.o obj/cbmconsole.o obj/emu6502.o
	$(CXX) -g -o c-simple-emu6502-cbm.exe obj/main.o obj/emuc64.o obj/emud64.o obj/cbmconsole.o obj/emu6502.o

obj/main.o: main.c emuc64.h emu6502.h
	mkdir -p obj
	$(CC) -g -o obj/main.o -c main.c

obj/emuc64.o: emuc64.c emuc64.h emu6502.h cbmconsole.h
	mkdir -p obj
	$(CC) -g -o obj/emuc64.o -c emuc64.c

obj/emud64.o: emud64.cpp emud64.h
	mkdir -p obj
	$(CC) -g -o obj/emud64.o -c emud64.cpp

obj/cbmconsole.o: cbmconsole.c cbmconsole.h 
	mkdir -p obj
	$(CC) -g -o obj/cbmconsole.o -c cbmconsole.c

obj/emu6502.o: emu6502.c emu6502.h
	mkdir -p obj
	$(CC) -g -o obj/emu6502.o -c emu6502.c
